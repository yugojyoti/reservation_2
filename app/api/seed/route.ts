...
export async function GET() {
  ...
  await prisma.cuisine.createMany({
    data: [{ name: "indian" }, { name: "italian" }, { name: "chinese" }],
  });
  ...
  const chineseCuisineId =
    cuisines.find((cuisine) => cuisine.name === "chinese")?.id || 1;
  const italianCuisineId =
    cuisines.find((cuisine) => cuisine.name === "italian")?.id || 1;

  const delhiLocationId =
    locations.find((location) => location.name === "delhi")?.id || 1;
  const mumbaiLocationId =
    locations.find((location) => location.name === "mumbai")?.id || 1;
  const kolkataLocationId =
    locations.find((location) => location.name === "kolkata")?.id || 1;
  ...
  await prisma.restaurant.createMany({
    data: [
      // INDIAN //
      {
        ...
        slug: "vivaan-fine-indian-cuisine-delhi",
      ...
      },
      {
        ...
        slug: "ramakrishna-indian-restaurant-delhi",
        location_id: delhiLocationId,
        cuisine_id: indianCuisineId,
      },
      {
      ...
      },
      {
        ...
        price: PRICE.REGULAR,
        description:
          "Welcome to Last Train to Delhi. We are a progressive Indian restaurant in the beautiful Glebe community in Delhi. Our speciality is Northern Indian food, classics like Murg Mahkini and some modern dishes like Crispy Shrimp. We are a small cozy restaurant, so make sure that you reserve through OpenTable.",
        images: [
        ...
        slug: "last-train-to-delhi-delhi",
        location_id: delhiLocationId,
        cuisine_id: indianCuisineId,
      },
      {
      ...
      },
      {
        ...
        open_time: "10:00:00.000Z",
        close_time: "21:00:00.000Z",
        slug: "kamasutra-indian-restaurant-and-wine-bar-kolkata",
        location_id: kolkataLocationId,
        cuisine_id: indianCuisineId,
      },
      // MEXICAN //
      ...
      },
      {
        ...
        price: PRICE.EXPENSIVE,
        description:
          "At La Bartola, we inspire a passion for authentic Chinese flavours. We use simple, fresh, and high-quality local & Mexican ingredients to craft delicious and thoughtful food.",
        images: [
      ...
      },
      {
        ...
        price: PRICE.EXPENSIVE,
        description:
          "The first location in India, from famed restauranteurs Noble 33, welcomes patrons into an immersive dining experience.",
        images: [
      ...
      },
      {
        ...
        open_time: "10:00:00.000Z",
        close_time: "21:00:00.000Z",
        slug: "terroni-sud-forno-produzione-e-spaccio-mumbai",
        location_id: mumbaiLocationId,
        cuisine_id: italianCuisineId,
      },
      {
